...
export default function CardCatalog({
  ...
  return (
    <div className="bg-white rounded-xl border border-bordeColumn m-[24px] p-[16px]">
      ...
      <div className="border border-bordeColumn m-[17px] px-[17px] py-[13px] rounded-xl max-w-max justify-center">
        <p className=" text-[14px] font-semibold text-grissubtexto">
          {description}
        </p>
      </div>
      <button className=" w-full flex font-bold text-[14px] text-letraBlanca items-center bg-FondoAzul rounded-xl px-[17px] p-2 justify-center">
        {button}
      </button>
    </div>
  );
